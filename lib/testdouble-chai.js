...
module.exports = function(chai, utils) {
  ...
  function calledHandler() {
    var msg, inverse_msg, passed, last_call, expected_args, actual_args, wantedArgs;

    expected_args = [].slice.call(arguments);
    wantedArgs = !!expected_args.length;
    ...
    try {
      ...
      msg = expectationMessageFor(this._obj, wantedArgs, false, !!last_call);
      inverse_msg = "";
    }
    ...
    this.assert(passed,                      // did assertion pass?
                ...
                wantedArgs);                 // do display the fancy test runner diff
  }


  function expectationMessageFor(testdouble, wantedArgs, isInverted, wasCalled) {
